---
type: profile
title: "Donny (xanoh) — Deckbuilder Profile"
owner: donny
handle: xanoh
alias: Donny
signature_commander: "Gladiolus Amicitia"
tags: [#profile]
related: [podlist/donny/persona]
decks: knowledgebase/podlist/donny/decks/
...
|---|---|
| Signature Commander | **Gladiolus Amicitia** ([*Forresta*](decks/forresta.md)) |
| Median Threat | **★★★★☆**\* |
...
## Decks
Full decklist archive: `knowledgebase/podlist/donny/decks/` (2 decks — see `INDEX.md` for the entries).
