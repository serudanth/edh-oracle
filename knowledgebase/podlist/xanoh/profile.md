...
## Overview
Two public decklists on file. "Forresta" (Gladiolus Amicitia, RG) is big-mana Gruul ramp built around a strong Final Fantasy Universes Beyond flavor theme. "The Sundering" (Ardbert, Warrior of Darkness, WB) is a different build entirely — removal-heavy Orzhov control/stax (Rule of Law, heavy protection and recursion) rather than tribal or ramp-stompy. With only two decks and two different colors/gameplans, no cross-deck pattern generalizes yet beyond "willing to build outside a single lane."
