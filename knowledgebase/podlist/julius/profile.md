---
type: profile
title: "Julius (j-py) — Deckbuilder Profile"
owner: julius
handle: j-py
alias: Julius
signature_commander: "Feather, the Redeemed"
tags: [#profile]
related: [podlist/julius/persona]
decks: knowledgebase/podlist/julius/decks/
...
|---|---|
| Signature Commander | **Feather, the Redeemed** ([*Miku Madness / Miku Sparta*](decks/miku-madness-miku-sparta.md)) |
| Median Threat | **★★★★☆**\* |
...
## Decks
Full decklist archive: `knowledgebase/podlist/julius/decks/` (1 deck — see `INDEX.md` for the entry).
