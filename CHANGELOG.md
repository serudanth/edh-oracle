...
- **[theorycrafting]** Created *The Apex Rush* (Winota, Joiner of Forces) theorycrafting workspace (`knowledgebase/theorycrafting/winota/`) containing complete 100-card decklist (`02-decklist.md`), architectural blueprint and piloting heuristics (`README.md`), donor audit (`01-salvage-pool.md`), and Archidekt 1-click import (`archidekt-export.txt`). Assembled an 8.5/10.0 power score stax-aggro and dual infinite combat combo engine with 100% owned card parity across fowlplays's active decks and ManaBox collection.
- **[theorycrafting]** Created *Blue Farm* (Tymna the Weaver & Kraum, Ludevic's Opus) theorycrafting workspace (`knowledgebase/theorycrafting/blue-farm/`) containing architectural blueprint (`01-discussion-and-architecture.md`), two complete 100-card decklists (`02-zero-cost-decklist.md` and `03-expanded-combo-decklist.md`), and Archidekt export files (`archidekt-export-v1.txt`, `archidekt-export-v2.txt`).
- **[kb]** Updated `knowledgebase/INDEX.md` indexing `theorycrafting/winota/`, `theorycrafting/blue-farm/`, the Reality Fracture dossier, and the operational metric calibration for Zimone X Bulldozer.
