...
@/media/Zodiark/Atelier/agent-core/core/ethics-and-risk.md
@/media/Zodiark/Atelier/agent-core/core/domains/edh.md
...
- **Research Operations:** Follow [`.claude/skills/edh-research/SKILL.md`](.claude/skills/edh-research/SKILL.md) and [`agent-core/core/domains/edh.md`](/media/Zodiark/Atelier/agent-core/core/domains/edh.md) for cache and network egress rules.
